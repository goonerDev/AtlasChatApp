(function(){
	...
	.service("Toastr", function(){
		this.show = function(msg, type, position){
			toastr.options.positionClass = position ? position : "toast-bottom-center";
			var _type = type ? type : "success";
			toastr[_type](msg);
		};
	})
	.provider("mylocalStorage", function () {
	    // var text = null;
